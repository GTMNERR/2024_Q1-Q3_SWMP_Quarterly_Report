...
September 2004 had the second highest monthly rainfall total recorded at the Pellicer Creek weather station (@tbl-topRain) and had the greated amount of rainfall when compared to annual September data (@fig-SeptPrecip; @fig-SeptPrecip-1; @fig-SeptPrecip-2). Total rainfall so far in 2024 is 1090.9 mm (@fig-SeptPrecip-3).
...
Rainfall in January brought salinities lower than their average daily ranges (@fig-range-sal), particularly at the stations farthest from the inlets (@fig-range-sal-1; @fig-range-sal-4). However, the drought conditions in spring made salinity levels rise. Salinities stayed above the average daily range at all stations through July but was most pronounced at Pine Island (@fig-range-sal-1). Salinity levels decreased to below the historic average daily range at all four stations in late August through September (@fig-range-sal-1; @fig-range-sal-2; @fig-range-sal-3; @fig-range-sal-4).
...
TopValues %>%
  ...
  rename(`Total Precipitation` = 'totprcp') %>% 
  kbl(align = "c") %>%
...
#|    - "Total precipitation 2002-2004."
#|    - "Annual precipitation totals 2002-2024."
#| layout-ncol: 2
## September Precip ----
...
ggplot(Monthly_PRCP, aes(x = Month, y = totprcp, fill = Month)) + 
